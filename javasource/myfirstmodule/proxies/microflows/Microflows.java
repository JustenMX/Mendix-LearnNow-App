...
public class Microflows
{
	...
	public static boolean aCO_ADE_Registrations_SetTotalNumberOfRegistrations(IContext context, myfirstmodule.proxies.Registration _registration)
	{
		Map<java.lang.String, Object> params = new HashMap<>();
		params.put("Registration", _registration == null ? null : _registration.getMendixObject());
		return (java.lang.Boolean) Core.microflowCall("MyFirstModule.ACO_ADE_Registrations_SetTotalNumberOfRegistrations").withParams(params).execute(context);
	}
